 ...
 * @author Vinit Rao
 */
public class SharkUI extends javax.swing.JFrame {
    ...
    public SharkUI() {
        ...
        this.setDefaultCloseOperation(SharkUI.DO_NOTHING_ON_CLOSE);
    ...
    private void initComponents() {
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/menugui/sharkfact.jpg"))); // NOI18N
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(SharkUI.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
