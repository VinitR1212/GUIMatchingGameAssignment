 ...
 * @author Vinit Rao
 */
public class SnapperUI extends javax.swing.JFrame {
    ...
    public SnapperUI() {
        ...
        this.setDefaultCloseOperation(SnapperUI.DO_NOTHING_ON_CLOSE);
    ...
    private void initComponents() {
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/menugui/snapperfact.jpg"))); // NOI18N
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(SnapperUI.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
