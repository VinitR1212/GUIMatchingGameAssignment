 ...
 * @author Vinit Rao
 */
public class DolphinUI extends javax.swing.JFrame {
    ...
    public DolphinUI() {
        ...
        this.setDefaultCloseOperation(DolphinUI.DO_NOTHING_ON_CLOSE);
    ...
    private void initComponents() {
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/menugui/dolphinfact.jpg"))); // NOI18N
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(DolphinUI.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
