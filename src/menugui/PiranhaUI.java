 ...
 * @author Vinit Rao
 */
public class PiranhaUI extends javax.swing.JFrame {
    ...
    public PiranhaUI() {
        ...
        this.setDefaultCloseOperation(PiranhaUI.DO_NOTHING_ON_CLOSE);
    ...
    private void initComponents() {
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/menugui/piranhafact.jpg"))); // NOI18N
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(PiranhaUI.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
