 ...
 * @author Vinit Rao
 */
public class PerchUI extends javax.swing.JFrame {
    ...
    public PerchUI() {
        ...
        this.setDefaultCloseOperation(PerchUI.DO_NOTHING_ON_CLOSE);
    ...
    private void initComponents() {
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/menugui/perchfact.jpg"))); // NOI18N
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(PerchUI.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
