 ...
 * @author Vinit Rao
 */
public class JellyfishUI extends javax.swing.JFrame {
    ...
    public JellyfishUI() {
        ...
        this.setDefaultCloseOperation(JellyfishUI.DO_NOTHING_ON_CLOSE);
    ...
    private void initComponents() {
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/menugui/jellyfishfact.jpg"))); // NOI18N
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(JellyfishUI.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new JellyfishUI().setVisible(true);
            }
        });
    }
